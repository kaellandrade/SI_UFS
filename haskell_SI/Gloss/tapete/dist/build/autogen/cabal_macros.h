...
/* package tapete-0.1.0.0 */
#define VERSION_tapete "0.1.0.0"
#define MIN_VERSION_tapete(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tapete-0.1.0.0"

#define CURRENT_PACKAGE_KEY "tapete-0.1.0.0"
