...
/* package curva-de-koch-0.1.0.0 */
#define VERSION_curva_de_koch "0.1.0.0"
#define MIN_VERSION_curva_de_koch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "curva-de-koch-0.1.0.0"

#define CURRENT_PACKAGE_KEY "curva-de-koch-0.1.0.0"
